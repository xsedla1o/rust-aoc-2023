...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `43.4µs` | `87.1µs` |
| [Day 2](./src/bin/02.rs) | `38.3µs` | `47.7µs` |
| [Day 3](./src/bin/03.rs) | `109.5µs` | `70.6µs` |
| [Day 4](./src/bin/04.rs) | `41.3µs` | `43.4µs` |
| [Day 5](./src/bin/05.rs) | `23.7µs` | `59.6µs` |
